...
- Usage: Reference from command with `@M:/programs/organizationTool/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to M:/programs/organizationTool/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to M:/programs/organizationTool/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
