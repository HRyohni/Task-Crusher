...
<!-- For checkpoint task examples and patterns, see @M:/programs/organizationTool/.gemini/get-shit-done/references/checkpoints.md -->
...
See `M:/programs/organizationTool/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `M:/programs/organizationTool/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `M:/programs/organizationTool/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
