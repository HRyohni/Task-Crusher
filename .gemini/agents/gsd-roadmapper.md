...
Reference full template: `M:/programs/organizationTool/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `M:/programs/organizationTool/.gemini/get-shit-done/templates/state.md`.
