...
Use template from `M:/programs/organizationTool/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `M:/programs/organizationTool/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "M:/programs/organizationTool/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
