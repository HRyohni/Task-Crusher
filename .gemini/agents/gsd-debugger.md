...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks M:/programs/organizationTool/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = M:/programs/organizationTool/.gemini/get-shit-done
                  → writes to M:/programs/organizationTool/.gemini/get-shit-done/hooks/
...
```bash
INIT=$(node "M:/programs/organizationTool/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "M:/programs/organizationTool/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "M:/programs/organizationTool/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
